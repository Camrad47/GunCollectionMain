package concreteguy.guncollection.config;
        ...
        public Client(ForgeConfigSpec.Builder builder) {
            builder.push("client");
            {
                enableGunEnchantmentGlint = builder
                        .comment("If true, renders enchanted guns from Gun Collection with the enchantment glint. True by default.")
                        .translation("config.guncollection.client.enable_gun_enchantment_glint")
