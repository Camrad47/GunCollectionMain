...
public abstract class AttachmentGC
{
    protected IGunModifierGC[] modifiers;
    private List<Component> perks = null;

    AttachmentGC(IGunModifierGC... modifiers)
    {
        this.modifiers = modifiers;
    }

    public IGunModifierGC[] getModifiers()
    {
    ...
    public static void addInformationEvent(ItemTooltipEvent event)
    {
        ...
        if(stack.getItem() instanceof IAttachmentGC<?>)
        {
            IAttachmentGC<?> attachment = (IAttachmentGC<?>) stack.getItem();
            ...
            IGunModifierGC[] modifiers = attachment.getProperties().getModifiers();
