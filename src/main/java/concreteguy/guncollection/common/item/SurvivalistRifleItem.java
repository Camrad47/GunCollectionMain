 ...
 * Author: Beton
 */
public class SurvivalistRifleItem extends Item {
    public SurvivalistRifleItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level world, List<Component> tooltips, TooltipFlag flag) {
        ...
        if (!Screen.hasShiftDown()) {
            ...
            tooltips.add(Component.translatable("tooltip.guncollection.survivalist_info_").withStyle(ChatFormatting.RED));
        }
    }
}
