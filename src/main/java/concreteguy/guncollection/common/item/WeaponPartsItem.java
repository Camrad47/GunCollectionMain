 ...
 * Author: Autovw
 */
public class WeaponPartsItem extends Item {
    public WeaponPartsItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level world, List<Component> tooltips, TooltipFlag flag) {
        ...
        if (!Screen.hasShiftDown()) {
            ...
            tooltips.add(Component.translatable("tooltip.guncollection.weapon_parts_info").withStyle(ChatFormatting.RED));
        }
    }
}
