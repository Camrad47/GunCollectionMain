 ...
 * Author: MrCrayfish
 */
public class rpgGrenadeFAEEntity extends ProjectileEntity
{
    public rpgGrenadeFAEEntity(EntityType<? extends ProjectileEntity> entityType, Level world)
    {
        super(entityType, world);
    }

    public rpgGrenadeFAEEntity(EntityType<? extends ProjectileEntity> entityType, Level world, LivingEntity shooter, ItemStack weapon, GunItem item, Gun modifiedGun)
    {
