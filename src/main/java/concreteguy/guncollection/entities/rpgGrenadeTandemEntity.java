 ...
 * Author: MrCrayfish
 */
public class rpgGrenadeTandemEntity extends ProjectileEntity
{
    public rpgGrenadeTandemEntity(EntityType<? extends ProjectileEntity> entityType, Level worldIn)
    {
        super(entityType, worldIn);
    }

    public rpgGrenadeTandemEntity(EntityType<? extends ProjectileEntity> entityType, Level worldIn, LivingEntity shooter, ItemStack weapon, GunItem item, Gun modifiedGun)
    {
