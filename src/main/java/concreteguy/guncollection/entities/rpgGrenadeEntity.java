 ...
 * Author: MrCrayfish
 */
public class rpgGrenadeEntity extends ProjectileEntity
{
    public rpgGrenadeEntity(EntityType<? extends ProjectileEntity> entityType, Level worldIn)
    {
        super(entityType, worldIn);
    }

    public rpgGrenadeEntity(EntityType<? extends ProjectileEntity> entityType, Level worldIn, LivingEntity shooter, ItemStack weapon, GunItem item, Gun modifiedGun)
    {
