 ...
 * Author: MrCrayfish
 */
public class rpgGrenadeTandemRenderer extends EntityRenderer<rpgGrenadeTandemEntity>
{
    public rpgGrenadeTandemRenderer(EntityRendererProvider.Context context)
    {
        super(context);
    }

    @Override
    public ResourceLocation getTextureLocation(rpgGrenadeTandemEntity entity)
    {
        return null;
    }

    @Override
    public void render(rpgGrenadeTandemEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource renderTypeBuffer, int light)
    {
