...
public class gc_ar15_sig_mcx_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_AR15_SIG_MCX_MAIN.getModel();
        ...
        {
            RenderUtil.renderModel(SpecialModels.GC_AR15_FOLDING_SIGHTS_MCX_DOWN.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        }
        else
        {
            RenderUtil.renderModel(SpecialModels.GC_AR15_FOLDING_SIGHTS_MCX_UP.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        }
