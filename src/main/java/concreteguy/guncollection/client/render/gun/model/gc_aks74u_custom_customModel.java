...
public class gc_aks74u_custom_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_AKS74U_CUSTOM_MAIN.getModel(), stack, poseStack, buffer, light, overlay);
