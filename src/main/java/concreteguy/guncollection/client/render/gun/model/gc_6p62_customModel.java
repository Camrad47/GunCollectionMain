...
public class gc_6p62_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_6P62_MAIN.getModel(), stack, poseStack, buffer, light, overlay);
        ...
        poseStack.translate(0, 0, cooldown/5);
        poseStack.translate(0, 5.8 * 0.0625, 0);
        RenderUtil.renderModel(SpecialModels.GC_6P62_BOLT.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        poseStack.popPose();

        RenderUtil.renderModel(SpecialModels.GC_6P62_BIPOD.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);

        if(Gun.getAttachment(IAttachment.Type.SCOPE, stack).getItem() == ItemRegistry.GC_SIGHT_OPTIC.get())
            RenderUtil.renderModel(SpecialModels.GC_6P62_SIGHT_RAIL.getModel(), stack, poseStack, buffer, light, overlay);
