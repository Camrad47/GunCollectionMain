...
public class gc_ak_zastava_m82_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_AK_ZASTAVA_M82_MAIN.getModel(), stack, poseStack, buffer, light, overlay);
