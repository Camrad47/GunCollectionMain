...
public class gc_ak74m_airsoft_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_AK74M_AIRSOFT.getModel(), stack, poseStack, buffer, light, overlay);
