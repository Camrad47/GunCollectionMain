...
public class gc_fn_fal_idf_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_FN_FAL_IDF_MAIN.getModel(), stack, poseStack, buffer, light, overlay);
