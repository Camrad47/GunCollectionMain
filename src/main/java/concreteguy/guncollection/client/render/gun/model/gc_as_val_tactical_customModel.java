...
public class gc_as_val_tactical_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_AS_VAL_TACTICAL_MAIN.getModel(), stack, poseStack, buffer, light, overlay);
