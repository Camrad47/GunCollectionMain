...
public class gc_kedr_krechet_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_KEDR_KRECHET_MAIN.getModel();
        ...
        {
            RenderUtil.renderModel(SpecialModels.GC_KRECHET_SIGHTS_DOWN.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        }
        else
        {
            RenderUtil.renderModel(SpecialModels.GC_KRECHET_SIGHTS_UP.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        }
        ...
        poseStack.translate(0, 5.8 * 0.0625, 0);
        RenderUtil.renderModel(SpecialModels.GC_KRECHET_BOLT.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        poseStack.popPose();
    }
