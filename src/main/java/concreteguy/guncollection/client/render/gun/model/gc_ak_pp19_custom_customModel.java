...
public class gc_ak_pp19_custom_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_AK_PP19_CUSTOM_MAIN.getModel(), stack, poseStack, buffer, light, overlay);
