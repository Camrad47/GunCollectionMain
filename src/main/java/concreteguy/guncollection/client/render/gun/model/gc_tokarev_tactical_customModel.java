...
public class gc_tokarev_tactical_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_TOKAREV_TACTICAL_MAIN.getModel();
        ...
        if (Gun.hasAmmo(stack)){
            ...
            poseStack.translate(0, 5.8 * 0.0625, 0);
            RenderUtil.renderModel(SpecialModels.GC_TOKAREV_TACTICAL_BOLT.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
            poseStack.popPose();
        } else {
