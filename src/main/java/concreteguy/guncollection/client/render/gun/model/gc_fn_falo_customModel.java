...
public class gc_fn_falo_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_FN_FALO_MAIN.getModel(), stack, poseStack, buffer, light, overlay);
