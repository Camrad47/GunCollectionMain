...
public class gc_aks74u_gunsmith_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_AKS74U_GUNSMITH_MAIN.getModel(), stack, poseStack, buffer, light, overlay);
