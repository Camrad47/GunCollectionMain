...
public class gc_ak_zastava_m72_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_AK_ZASTAVA_M72_MAIN.getModel(), stack, poseStack, buffer, light, overlay);
