...
public class gc_famas_g1_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_FAMAS_G1_MAIN.getModel();
        ...
        poseStack.translate(0, 5.8 * 0.0625, 0);
        RenderUtil.renderModel(SpecialModels.GC_FAMAS_BOLT.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        poseStack.popPose();
    }
