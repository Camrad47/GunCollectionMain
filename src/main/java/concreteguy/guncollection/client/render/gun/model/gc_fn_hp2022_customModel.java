...
public class gc_fn_hp2022_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_FN_HP2022_MAIN.getModel();
        ...
        if (Gun.hasAmmo(stack)){
            ...
            poseStack.translate(0, 5.8 * 0.0625, 0);
            RenderUtil.renderModel(SpecialModels.GC_FN_HP2022_BOLT.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
            poseStack.popPose();
        } else {
