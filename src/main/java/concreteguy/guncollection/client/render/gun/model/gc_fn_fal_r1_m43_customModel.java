...
public class gc_fn_fal_r1_m43_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_FN_FAL_R1_M43_MAIN.getModel(), stack, poseStack, buffer, light, overlay);
