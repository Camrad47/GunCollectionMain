...
public class gc_ak_psl_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_AK_PSL_MAIN.getModel(), stack, poseStack, buffer, light, overlay);
