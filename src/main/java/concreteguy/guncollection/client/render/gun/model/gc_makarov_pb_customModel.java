...
public class gc_makarov_pb_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_MAKAROV_PB_MAIN.getModel();
        ...
        if (Gun.hasAmmo(stack)){
            ...
            poseStack.translate(0, 5.8 * 0.0625, 0);
            RenderUtil.renderModel(SpecialModels.GC_MAKAROV_PB_BOLT.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
            poseStack.popPose();
        } else {
            poseStack.translate(0, 0, 0.08);
            RenderUtil.renderModel(SpecialModels.GC_MAKAROV_PB_BOLT.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        }
    }
