...
public class gc_ak_hunter_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_AK_HUNTER_MAIN.getModel(), stack, poseStack, buffer, light, overlay);
