...
public class gc_mini_uzi_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_MINI_UZI_MAIN.getModel();
        ...
        poseStack.pushPose();
        poseStack.translate(0, -5.8 * 0.1025, 0);
        poseStack.translate(0, 0, -(cooldown/8));
        poseStack.translate(0, 5.8 * 0.1025, 0);
        RenderUtil.renderModel(SpecialModels.GC_MINI_UZI_BOLT.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        poseStack.popPose();
    }
