...
public class gc_colt_double_eagle_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_COLT_DOUBLE_EAGLE_MAIN.getModel();
        ...
        if (Gun.hasAmmo(stack)){
            ...
            poseStack.translate(0, 5.8 * 0.0625, 0);
            RenderUtil.renderModel(SpecialModels.GC_COLT_DOUBLE_EAGLE_BOLT.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
            poseStack.popPose();
        } else {
