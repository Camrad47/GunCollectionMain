...
public class gc_fn_fal_tactical_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_FN_FAL_TACTICAL_MAIN.getModel(), stack, poseStack, buffer, light, overlay);
