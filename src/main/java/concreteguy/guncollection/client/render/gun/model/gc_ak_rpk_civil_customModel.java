...
public class gc_ak_rpk_civil_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_AK_RPK_CIVIL_MAIN.getModel(), stack, poseStack, buffer, light, overlay);
