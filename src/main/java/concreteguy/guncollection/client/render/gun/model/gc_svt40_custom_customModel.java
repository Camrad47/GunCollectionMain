...
public class gc_svt40_custom_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_SVT40_CUSTOM_MAIN.getModel();
        ...
        poseStack.translate(0, 5.8 * 0.0625, 0);
        RenderUtil.renderModel(SpecialModels.GC_SVT_CUSTOM_BOLT.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        poseStack.popPose();
    }
