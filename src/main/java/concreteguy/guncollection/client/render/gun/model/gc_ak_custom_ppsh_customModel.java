...
public class gc_ak_custom_ppsh_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_AK_CUSTOM_PPSH_MAIN.getModel();
        ...
        RenderUtil.renderModel(SpecialModels.GC_AK_DRUM_MAG.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        poseStack.popPose();
