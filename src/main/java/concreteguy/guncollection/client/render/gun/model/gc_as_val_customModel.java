...
public class gc_as_val_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_AS_VAL_MAIN.getModel(), stack, poseStack, buffer, light, overlay);
