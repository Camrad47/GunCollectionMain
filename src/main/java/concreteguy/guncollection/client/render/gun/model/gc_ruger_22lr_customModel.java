...
public class gc_ruger_22lr_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_RUGER_22LR_MAIN.getModel();
        ...
        poseStack.translate(0, 0, cooldown/14);
        poseStack.translate(0, 5.8 * 0.0625, 0);
        RenderUtil.renderModel(SpecialModels.GC_RUGER_22LR_BOLT.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        poseStack.popPose();
    }
