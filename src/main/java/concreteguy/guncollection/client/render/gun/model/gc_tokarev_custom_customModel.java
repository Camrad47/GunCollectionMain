...
public class gc_tokarev_custom_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_TOKAREV_CUSTOM_MAIN.getModel();
        ...
        {
            RenderUtil.renderModel(SpecialModels.GC_TOKAREV_CUSTOM_SILENCER.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        }
        ...
        if (Gun.hasAmmo(stack)){
            ...
            poseStack.translate(0, 5.8 * 0.0625, 0);
            RenderUtil.renderModel(SpecialModels.GC_TOKAREV_TT_BOLT.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
            poseStack.popPose();
        } else {
