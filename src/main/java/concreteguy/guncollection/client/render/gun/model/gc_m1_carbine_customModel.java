...
public class gc_m1_carbine_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_M1_CARBINE_MAIN.getModel();
        ...
        if(!attachmentStack.isEmpty())
        {
            if(Gun.getAttachment(IAttachment.Type.STOCK, stack).getItem() == ItemRegistry.GC_WOOD_STOCK.get())
                RenderUtil.renderModel(SpecialModels.GC_M1_CARBINE_PARTS_WOOD.getModel(), stack, poseStack, buffer, light, overlay);
            if(Gun.getAttachment(IAttachment.Type.STOCK, stack).getItem() == ItemRegistry.GC_METAL_STOCK.get())
                RenderUtil.renderModel(SpecialModels.GC_M1_CARBINE_PARTS_METAL.getModel(), stack, poseStack, buffer, light, overlay);
            ...
            if(Gun.getAttachment(IAttachment.Type.STOCK, stack).getItem() == ItemRegistry.GC_ULTRA_LIGHT_STOCK.get())
                RenderUtil.renderModel(SpecialModels.GC_M1_CARBINE_PARTS_ULTRA_LIGHT.getModel(), stack, poseStack, buffer, light, overlay);
        ...
        {
            RenderUtil.renderModel(SpecialModels.GC_M1_CARBINE_PARTS_MAIN.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        }
