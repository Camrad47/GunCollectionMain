...
public class gc_fn_fal_sniper_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_FN_FAL_SNIPER_MAIN.getModel(), stack, poseStack, buffer, light, overlay);
