...
public class gc_ak104_customModel implements IOverrideModel {
    ...
    {
        RenderUtil.renderModel(SpecialModels.GC_AK104_MAIN.getModel(), stack, poseStack, buffer, light, overlay);
