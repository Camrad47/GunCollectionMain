...
public class gc_m1911_auto_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_M1911_AUTO_MAIN.getModel();
        ...
        if (Gun.hasAmmo(stack)){
            ...
            poseStack.translate(0, 0, cooldown/3);
            poseStack.translate(0, 5.8 * 0.0625, 0);
            RenderUtil.renderModel(SpecialModels.GC_M1911_AUTO_BOLT.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
            poseStack.popPose();
        } else {
