...
public class gc_ak_saiga12_tactical_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_AK_SAIGA12_TACTICAL_MAIN.getModel();
        ...
        ItemStack attachmentStack = Gun.getAttachment(IAttachment.Type.BARREL, stack);
        if(!attachmentStack.isEmpty())
        {
            RenderUtil.renderModel(SpecialModels.GC_AK_SAIGA12_TACTICAL_SILENCER.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        }
