...
public class gc_mauser_c96_trench_carbine_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_MAUSER_C96_TRENCH_CARBINE_MAIN.getModel();
        ...
        if (Gun.hasAmmo(stack)){
            ...
            poseStack.translate(0, 5.8 * 0.0625, 0);
            RenderUtil.renderModel(SpecialModels.GC_PASAM_BOLT.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
            poseStack.popPose();
        } else {
