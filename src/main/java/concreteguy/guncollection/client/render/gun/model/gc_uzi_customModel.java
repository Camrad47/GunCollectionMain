...
public class gc_uzi_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_UZI_MAIN.getModel();
        ...
        poseStack.translate(0, 5.8 * 0.1025, 0);
        RenderUtil.renderModel(SpecialModels.GC_UZI_BOLT.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        poseStack.popPose();
    }
