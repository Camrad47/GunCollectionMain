...
public class gc_mosin_tokarev_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_MOSIN_TOKAREV_MAIN.getModel();
        ...
        poseStack.translate(0, 5.8 * 0.0625, 0);
        RenderUtil.renderModel(SpecialModels.GC_MOSIN_TOKAREV_BOLT.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        poseStack.popPose();
    }
