...
public class gc_ar15_mk47_dissent_customModel implements IOverrideModel {
    ...
    {
        BakedModel bakedModel = SpecialModels.GC_AR15_MK47_DISSENT_MAIN.getModel();
        ...
        {
            RenderUtil.renderModel(SpecialModels.GC_AR15_FOLDING_SIGHTS_SR25_DOWN.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        }
        else
        {
            RenderUtil.renderModel(SpecialModels.GC_AR15_FOLDING_SIGHTS_SR25_UP.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        }
        ...
        poseStack.translate(0, 5.8 * 0.0625, 0);
        RenderUtil.renderModel(SpecialModels.GC_AR15_BLK_BOLT.getModel(), display, null, stack, parent, poseStack, buffer, light, overlay);
        poseStack.popPose();
    }
