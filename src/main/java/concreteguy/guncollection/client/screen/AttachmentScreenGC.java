package concreteguy.guncollection.client.screen;
 ...
 * Author: MrCrayfish
 */
public class AttachmentScreenGC extends AbstractContainerScreen<AttachmentContainer>
{
    ...
    public AttachmentScreenGC(AttachmentContainer screenContainer, Inventory playerInventory, Component titleIn)
    {
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        for(int i = 0; i < IAttachmentGC.Type.values().length; i++)
        {
            ...
            {
                IAttachmentGC.Type type = IAttachmentGC.Type.values()[i];
    ...
    private boolean canPlaceAttachmentInSlot(ItemStack stack, Slot slot)
    {
        ...
        if(!(stack.getItem() instanceof IAttachmentGC<?> a)) return true;
    ...
    private boolean isCompatible(ItemStack stack, AttachmentSlot slot)
    {
        ...
        if(!(stack.getItem() instanceof IAttachmentGC<?> attachment)) return false;
